...
const Navbar = () => {
    ...
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
      ...
      <a href="https://superseed.club/" className="flex items-center">
      ...
      <div className="flex md:order-2">
          <button type="button" className="button-5 text-black bg-green-400 hover:bg-black-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Connect Wallet</button>
