...
const Invest = () => {
    return(
        <>
        <Navbar/>
        <section className="relative py-0 bg-white tails-selected-element" contenteditable="true">
                        ...
                        <div className="mt-10 relative z-10 flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl 2xl:static 2xl:mx-0">
                            <div className="relative w-full ">
                                <div className="mt-2 relative">
                                    <label className="justify-start font-bold text-green-500">I want to convert</label>
        ...
        <div className="px-20 relative flex flex-col items-start justify-start p-10 bg-black shadow-2xl rounded-xl 2xl:static 2xl:mx-0">
                            ...
                            <div className="relative w-full mt-6 space-y-8">
                                ...
                                <form className="grid max-w-3xl gap-4 mx-auto sm:grid-cols-2">
                                    <div className="">
                                        <label for="pay" className="inline-block mb-2 text-sm font-medium text-green-300 sm:text-base">Pay In: </label>
                                    ...
                                    <div className="">
                                        <label for="select-token" className="inline-block mb-2 text-sm font-medium text-green-400 sm:text-base">Amount:</label>
